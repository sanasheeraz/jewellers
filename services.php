	...
	<div id="services" class="parallax section lb">
        <div class="container">
            ...
            <div class="owl-services owl-carousel owl-theme">
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="uploads/about_9.jpeg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="uploads/about_9.jpeg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
                    <h3>Earing Bunde</h3>
